                                ...
                                <TableBody>
                                    {products.map((product, index) => (
                                        <TableRow key={index}>
                                            ...
                                            <TableCell style={{ border: '1px solid #ddd' }}>{proData.find(pro => pro.pro_id === product.pro_id)?.pro_name}</TableCell>
                                            ...
                                            <TableCell style={{ border: '1px solid #ddd' }}>{(parseFloat(product.price) * parseFloat(product.quantity)).toFixed(2)}</TableCell>
                                        </TableRow>
                                    ))}
                                </TableBody>
                            </Table>
                ...
                <DialogContent>
                    <div style={{ fontFamily: 'Arial, sans-serif', maxWidth: '800px', margin: 'auto', padding: '20px', border: '1px solid #ddd', borderRadius: '8px', backgroundColor: '#f9f9f9' }}>
                        ...
                        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', borderBottom: '3px solid #004d40', paddingBottom: '10px' }}>
                            <img src={logo} alt="Company Logo" width='150' height='auto' />
                            <div style={{ textAlign: 'center' }}>
                                <Typography variant="h4" style={{ fontWeight: 'bold', color: '#004d40' }}>Invoice</Typography>
                                ...
                                <TableBody>
                                    {products.map((product, index) => (
                                        <TableRow key={index}>
                                            <TableCell style={{ border: '1px solid #ddd' }}>{index + 1}</TableCell>
                                            <TableCell style={{ border: '1px solid #ddd' }}>{proData.find(pro => pro.pro_id === product.pro_id)?.pro_name}</TableCell>
                                            <TableCell style={{ border: '1px solid #ddd' }}>{proData.find(pro => pro.pro_id === product.pro_id)?.description}</TableCell>
                                            <TableCell style={{ border: '1px solid #ddd' }}>{product.quantity}</TableCell>
                                            <TableCell style={{ border: '1px solid #ddd' }}>{parseFloat(product.price).toFixed(2)}</TableCell>
                                            <TableCell style={{ border: '1px solid #ddd' }}>{(parseFloat(product.price) * parseFloat(product.quantity)).toFixed(2)}</TableCell>
                                        </TableRow>
