...
//   // Safely get properties from data object
...
//           <Typography>{data.cust_name || 'N/A'}</Typography>
//           <Typography>{data.cust_mobile || 'N/A'}</Typography>
//           <Typography>{data.cust_email || 'N/A'}</Typography>
//         </Grid>
//         <Grid item xs={4}>
...
//               <TableCell style={{ border: '1px solid #ddd', padding: '8px' }}>{data.pro_name || 'N/A'}</TableCell>
//               <TableCell style={{ border: '1px solid #ddd', padding: '8px' }}>{data.specification || 'N/A'}</TableCell>
//               <TableCell style={{ border: '1px solid #ddd', padding: '8px' }}>{data.quantity || 'N/A'}</TableCell>
  ...
  return (
    <div style={{ fontFamily: 'Arial, sans-serif', fontSize: '12px', backgroundColor: '#e8f5e9', padding: '20px', borderRadius: '8px' }}>
      ...
      <Grid container spacing={3} alignItems="center">
        ...
        <Grid item xs={4}>
          <Typography variant="h6">
            <span style={{ fontWeight: 'bold', color: '#2196F3' }}>Invoice Date: </span> {moment(invoiceData.created_at).format('YYYY-MM-DD')}
          </Typography>
          <Typography variant="h6" style={{ marginTop: '8px' }}>
