// import { Button, Dialog, DialogActions, DialogContent, DialogTitle, FormControl, Grid, MenuItem, Paper, Select, Table, TableBody, TableCell, TableContainer, TableHead, TableRow, Pagination } from '@mui/material';
...
const ProductIndex = () => {
    ...
    const handleScan = (data) => {
        if (data) {
            ...
            if (productId) {
                axios.get(`${config.apiUrl}/product/${productId}`)
                    .then((res) => {
        ...
        <>
            ...
            <TableContainer component={Paper} className='mt-5'>
                <Table>
                    <TableHead>
                        <TableRow>
                            <TableCell style={{ fontWeight: 'bold' }} className="no-print">S.No</TableCell>
                            <TableCell style={{ fontWeight: 'bold' }}>Product Name</TableCell>
                            <TableCell style={{ fontWeight: 'bold' }} className="no-print">Product Image</TableCell>
                            <TableCell className="no-print">Product Description</TableCell>
                            <TableCell style={{ fontWeight: 'bold' }} className="no-print">Specification</TableCell>
                            <TableCell style={{ fontWeight: 'bold' }}>Barcode</TableCell>
                            <TableCell style={{ fontWeight: 'bold' }} className="no-print">Action</TableCell>
                        </TableRow>
                    </TableHead>
                    <TableBody>
                        {currentData.map((pro, index) => (
